...
class ContentDetailMapper
{
    ...
    /**
     * Сохранить
     * @param ContentDetailModel $entity
     * @return void
     * @throws ReflectionException
     */
    public function save(ContentDetailModel $entity)
    {
     ...
     * @return list<ContentDetailModel>
     */
    public function findBy(ContentDetailConditions $conditions)
    {
    ...
    /**
     * Получить гидратор
     * @return ContentDetailHydrator
     */
    protected function getHydrator()
    {
        return new ContentDetailHydrator();
    }
