...
class AnswerMapper
{
    ...
    private $table = 'lms_tests_answers';
    ...
    /**
     * Сохранить
     * @param AnswerModel $entity
     * @return void
     * @throws ReflectionException
     */
    public function save(AnswerModel $entity)
    {
     ...
     */
    public function findBy(AnswerConditions $conditions)
    {
