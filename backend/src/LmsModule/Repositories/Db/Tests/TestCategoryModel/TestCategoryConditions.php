...
class TestCategoryConditions
{
     ...
     * @var array{TestCategoryConditions, string}[]
     */
    ...
    public function getId()
    {
        if (!isset($this->conditions['id'])) {
            $this->conditions["id"] = new Conditions\IntCondition("c.id");
        }
    ...
    public function getCourseId()
    {
        if (!isset($this->conditions['courseId'])) {
            $this->conditions["courseId"] = new Conditions\IntCondition("c.course_id");
        }
    ...
    public function getTitle()
    {
        if (!isset($this->conditions['title'])) {
            $this->conditions["title"] = new Conditions\StringCondition("c.title");
        }
     ...
     * @return $this
     */
    public function addConditions(TestCategoryConditions $conditions, $mode = 'AND')
    {
