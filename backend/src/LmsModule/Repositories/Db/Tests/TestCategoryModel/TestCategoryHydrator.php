...
class TestCategoryHydrator
{
    ...
    /** @var ReflectionClass<TestCategoryModel>|null */
    ...
    /**
     * @return ReflectionClass<TestCategoryModel>
     */
    private static function getReflectionClass()
    {
        return self::$classReflection ?: self::$classReflection = new ReflectionClass(TestCategoryModel::class);
    }

    /**
     * Заполнить объект данными
     * @param TestCategoryModel $object
     * @param array<non-empty-string, mixed> $data
     * @return TestCategoryModel
     */
    public function hydrate(TestCategoryModel $object, array $data)
    {
     ...
     * @throws ReflectionException
     */
    public function extract(TestCategoryModel $object)
    {
        $dbData = [];
     ...
     * @throws ReflectionException
     */
    public function hydrateProperty(TestCategoryModel $object, $property, $value)
    {
     ...
     * @throws ReflectionException
     */
    public function extractProperty(TestCategoryModel $object, $property)
    {
