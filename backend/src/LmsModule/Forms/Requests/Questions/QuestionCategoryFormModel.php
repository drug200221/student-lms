<?php
namespace Psk\LmsModule\Forms\Requests\Questions;

use Psk\LmsModule\Models\Requests\Questions\QuestionCategoryRequestModel;
...
class QuestionCategoryFormModel extends FormModel
{
    ...
    /**
     * @return QuestionCategoryRequestModel
     */
    public function getDataModel()
    {
        $model = new QuestionCategoryRequestModel();
